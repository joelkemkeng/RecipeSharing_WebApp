                      ...
                      ?>
                        ...
                        <?php
                         foreach($results as $key => $row){
                          ...
                          echo'<a href="http://15.188.49.243/RecipeSharing_WebApp/RecipeHomepage/recipepage.php?recipe_id='.htmlentities($row['Recipe_ID']).'" target="_blank" class="link text-primary h4 mx-1" title="View Recipe"><i class="bi-box-arrow-in-right"></i></a>';
                          echo'<a href="http://15.188.49.243/RecipeSharing_WebApp/baker/update_recipe.php?recipe_id='.htmlentities($row['Recipe_ID']).'" class="link text-info h5 mx-1" title="Edit Recipe"><i class="bi bi-pencil-square"></i></a>';
