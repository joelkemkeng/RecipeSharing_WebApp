<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save'])){
    ...
    if (isset($_FILES['recipe_image']) && $_FILES['recipe_image']['error'] == UPLOAD_ERR_OK){
      ...
      $Rcp_Picture = 'http://localhost/RecipeSharing_WebApp/assets/dist/img/default_image.jpg'; //Default image
    }
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="http://localhost/RecipeSharing_WebApp/baker/add_recipe.php" class="nav-link active bg-gray">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Recipe</p>
                </a>
              </li>
                ...
                <div class="card-body text-dark">
                 ...
                 <div class="row d-grid gx-2">
                  ...
                  <label for="customFile">Recipe Image</label><label class="bg-danger ml-1 px-2 rounded-pill text-xs" for="inputError"><?php if(!empty($pic_error)) echo'<i class="far fa-times-circle"></i> '.$pic_error.'';?></label>
                    ...
                    <img id="imagePreview" src="<?php if($Rcp_Picture !== 'http://localhost/RecipeSharing_WebApp/assets/dist/img/default_image.jpg') echo htmlspecialchars($Rcp_Picture); ?>" alt="Image Preview" style="display: <?php echo isset($Rcp_Picture) && $Rcp_Picture !== '' ? 'block' : 'none'; ?>; max-width: 200px; margin-top: 10px;">
                  </div>
