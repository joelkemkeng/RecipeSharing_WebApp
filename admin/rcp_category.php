          ...
          <?php require(__DIR__ . '/../alert.php'); ?>
            ...
            <div class="card-header bg-dark d-flex justify-content-start align-items-center">
                ...
                <div class="btn btn-flat rounded-right bg-gray input-group-append text-nowrap" style="font-size: 0.95rem;">
                  <a href="http://15.188.49.243/RecipeSharing_WebApp/admin/rcp_category.php"><i class="bi bi-x-lg"></i></a>
                </div>
                </div>
              </div>
              <!-- /.card-header -->
                      ...
                      <?php
                       if(isset($result) && !empty($result)){
                        foreach($result as $key => $row){
                          ...
                          echo'<a href="http://15.188.49.243/RecipeSharing_WebApp/admin/update_category.php?category_id='.htmlentities($row['Category_ID']).'" class="link text-info h5 mx-1" title="Edit Category"><i class="bi bi-pencil-square"></i></a>';
