...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="http://15.188.49.243/RecipeSharing_WebApp/assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="http://15.188.49.243/RecipeSharing_WebApp/assets/plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="http://15.188.49.243/RecipeSharing_WebApp/assets/plugins/summernote/summernote-bs4.min.css">
</head>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
              <li class="nav-item">
                <a href="http://15.188.49.243/RecipeSharing_WebApp/admin/dashboard.php" class="nav-link active bg-orange">
...
<!-- ChartJS -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/moment/moment.min.js"></script>
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/daterangepicker/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="http://15.188.49.243/RecipeSharing_WebApp/assests/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
