<?php
  ...
  $query = $conn->prepare("SELECT * FROM rcp_categories WHERE Category_ID = :Category_ID LIMIT 1");
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save'])){  
    ...
    if(empty($category_error)){
      updatedata2($category_ID, $category_name, $category_criteria);
    }
  }
?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="http://15.188.49.243/RecipeSharing_WebApp/admin/rcp_category.php" class="nav-link active bg-gray">
                      <i class="far fa-circle nav-icon"></i>
    ...
    <section class="content-header">
      <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active text-white-50">Update Recipe Category</li>
            </ol>
      </div>
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-auto">
            <h1><b>Update Recipe Category</b></h1>
            <span>Fill out the form to update the category to the platform.</span>
          </div>
        </div>
          ...
          <div class="col-9">
            ...
            <div class="card ml-5">
              <div class="card-header bg-dark d-inline-flex align-items-center">
                ...
                <a href="http://15.188.49.243/RecipeSharing_WebApp/admin/rcp_category.php" class="btn ml-auto">
              ...
              <form action="" method="post">
                ...
                <div class="row align-items-center">
                  <div class="col-6 form-group ml-3">
                    ...
                    <input type="text" class="form-control <?php if(!empty($category_error))echo 'border-danger';?>" name="category_name" placeholder="Enter category name"  value="<?php echo $row['Category_Name'];?>">
                    <label class="mt-3">Category Criteria</label>
                    <select class="custom-select" style="width: 100%;" name="criteria" required>
                      <option class="h6 bg-dark" value="Dessert"<?php echo ($row['Category_Criteria'] == 'Dessert Type') ?"selected":'';?>>Dessert Type</option>
                      <option class="h6 bg-dark" value="Cuisine"<?php echo ($row['Category_Criteria'] == 'Cuisine') ?"selected":'';?>>Cuisine</option>
                      <option class="h6 bg-dark" value="Dietary"<?php echo ($row['Category_Criteria'] == 'Dietary') ?"selected":'';?>>Dietary Restriction</option>
                      <option class="h6 bg-dark" value="Occasion"<?php echo ($row['Category_Criteria'] == 'Occasion') ?"selected":'';?>>Occasion</option>
                    </select>
                    <button type="submit" name="save" value="submit" class="btn btn-success col-3 mt-4" >Change</button>
