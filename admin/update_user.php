<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save'])){
    ...
    if(empty($f_error) && empty($l_error) && empty($gender_error) && empty($role_error) && empty($emailerror)){
      if($_SESSION['useremail'] == $row['Email']){
        $_SESSION['user_name']= $_POST['fname'].' '.$_POST['lname'];
      }
      updatedata($user_ID, $fname, $lname, $gender, $email, $role);
    }
  }
?>
    ...
    <section class="content-header">
      <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active text-white-50">Update User</li>
            </ol>
      </div>
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-auto">
            ...
            <span>Fill out the form to change the user details to the platform.</span>
          </div>
        </div>
          ...
          <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-header bg-dark d-inline-flex align-items-center">
                ...
                <a href="http://15.188.49.243/RecipeSharing_WebApp/admin/index.php" class="btn ml-auto">
              ...
              <form action="" method="post">
                ...
                <div class="card-body text-dark pb-5">
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" name="gender" value="Male"<?php echo ($row['Gender'] == 'Male')?"checked":"";?>> <label style="font-weight: normal;"> Male</label><br>
                    <input type="radio" name="gender" value="Female"<?php echo ($row['Gender'] == 'Female')? "checked":"";?>> <label style="font-weight: normal;"> Female</label>
                  </div>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php if(!empty($emailerror))echo 'border-danger';?>" placeholder="Enter email" name="email" value="<?php echo $row['Email'];?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer" style= text-align:center;>
                  <button type="submit" name="save" value="submit" class="btn btn-success col-3" >Change</button>
